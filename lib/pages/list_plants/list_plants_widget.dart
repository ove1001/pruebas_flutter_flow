...
import 'list_plants_model.dart';
export 'list_plants_model.dart';

class ListPlantsWidget extends StatefulWidget {
  const ListPlantsWidget({Key? key}) : super(key: key);

  @override
  _ListPlantsWidgetState createState() => _ListPlantsWidgetState();
}

class _ListPlantsWidgetState extends State<ListPlantsWidget> {
  late ListPlantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListPlantsModel());
